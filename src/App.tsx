      ...
      <div className="w-full z-10 min-h-screen flex flex-col items-center text-white">
        ...
        <div className="fixed top-0 left-0 w-full px-4 pt-8 z-10 flex flex-col items-center text-white">
          <div className="w-full cursor-pointer">
            <div className="bg-[#1f1f1f] text-center py-2 rounded-xl">
              <p className="text-lg">Warning : Please check the pinned message of FUNDTAL telegram channel before mining. <Arrow size={18} className="ml-0 mb-1 inline-block" /></p>
            </div>
          </div>
          ...
          <div className="text-base mt-2 flex items-center">
            ...
            <span className="ml-1">t.me/FUNDTAL <Arrow size={18} className="ml-0 mb-1 inline-block" /></span>
          </div>
        </div>
        ...
        <div className="fixed bottom-0 left-0 w-full px-4 pb-4 z-10">
          ...
          <div className="w-full bg-[#f9c035] rounded-full mt-4">
            <div className="bg-gradient-to-r from-[#f3c45a] to-[#fffad0] h-4 rounded-full" style={{ width: `${(energy / 5000) * 100}%` }}></div>
          </div>
        </div>
